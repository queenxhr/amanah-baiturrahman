...
<head>
    <meta charset="utf-8">
    <title>Transaksi Wakaf Ditolak</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Transaksi Wakaf Ditolak</p>
        </div>
        <div class="content">
            <p class="welcome-text">Assalamualaikum Warahmatullahi Wabarakatuh,</p>
            <p>Mohon maaf, tim Nazhir kami telah melakukan verifikasi dan memutuskan untuk menolak transaksi wakaf Anda. Penolakan ini biasanya terjadi karena bukti pembayaran yang diunggah tidak valid, buram, tidak terbaca, atau nominal transfer tidak sesuai.</p>
            
            <div class="error-box">
                <h3>Verifikasi Ditolak (Gagal)</h3>
                <p>Status pembayaran Anda saat ini telah ditandai sebagai <strong>DITOLAK / GAGAL</strong>. Rincian kuitansi penolakan resmi transaksi wakaf Anda telah kami lampirkan dalam format PDF pada email ini.</p>
            </div>
            ...
            <p style="font-size: 13px; color: #6b7280; font-style: italic; text-align: center; margin-top: 40px;">
                Jika Anda merasa ini adalah kekeliruan atau ingin melakukan transfer ulang dengan bukti yang valid, silakan lakukan transaksi wakaf kembali melalui portal Amanah Baiturrahman atau hubungi kami melalui kontak resmi.
            </p>
        </div>
        <div class="footer">
