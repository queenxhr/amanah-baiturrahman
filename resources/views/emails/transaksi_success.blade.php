...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Bukti Pembayaran Wakaf Diterima</p>
        </div>
        <div class="content">
            <p class="welcome-text">Assalamualaikum Warahmatullahi Wabarakatuh,</p>
            <p>Alhamdulillah, kami telah menerima bukti pembayaran/transfer yang Anda unggah untuk transaksi wakaf berikut:</p>
            ...
            <div class="status-box">
                ...
                <p>Saat ini tim Nazhir kami sedang memeriksa dan melakukan verifikasi manual terhadap bukti pembayaran yang Anda kirimkan.</p>
                <p style="margin-top: 10px;">Setelah proses verifikasi berhasil disetujui, kami akan mengirimkan kuitansi resmi penerimaan wakaf langsung ke email Anda.</p>
            </div>

            <p style="font-size: 13px; color: #6b7280; font-style: italic; text-align: center; margin-top: 40px;">
                Jazakumullah Khairan Katsiran atas partisipasi Anda dalam program wakaf Amanah Baiturrahman.
            </p>
        </div>
        <div class="footer">
