...
return [
    ...
    */
    ...
    'in_array_keys' => 'Kolom :attribute harus berisi setidaknya salah satu dari kunci berikut: :values.',
    ...
    'missing_if' => 'Kolom :attribute harus hilang ketika :other berisi :value.',
    'missing_unless' => 'Kolom :attribute harus hilang kecuali jika :other berisi :value.',
    ...
    'present_unless' => 'Kolom :attribute harus ada kecuali jika :other berisi :value.',
    ...
    'prohibited_unless' => 'Kolom :attribute dilarang kecuali jika :other ada di dalam :values.',
    ...
    'required_unless' => 'Kolom :attribute wajib diisi kecuali jika :other ada di dalam :values.',
    ...
    */
    ...
    'custom' => [
        'password' => [
            'min' => 'Kolom kata sandi harus minimal :min karakter.',
        ],
        'new_password' => [
            'min' => 'Kolom kata sandi baru harus minimal :min karakter.',
        ],
    ],
    ...
    | ganti "email". Ini membantu kami membuat pesan kami lebih ekspresif.
    |
    */
